...
trainImg = cv2.imread(r'C:\Users\Aman\Desktop\School\Python\frontStitchingImageWarped.png')
trainImg_gray = cv2.cvtColor(trainImg, cv2.COLOR_RGB2GRAY)
queryImg = cv2.imread(r'C:\Users\Aman\Desktop\School\Python\leftStitchingImageWarped.png')
