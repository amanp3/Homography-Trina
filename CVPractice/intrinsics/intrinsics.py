...
rms, mtx, dist, rvecs, tvecs = cv.calibrateCamera(objpoints, imgpoints,
    (w, h), None, None, flags=(cv.CALIB_RATIONAL_MODEL))# | cv.CALIB_THIN_PRISM_MODEL | cv.CALIB_TILTED_MODEL))
