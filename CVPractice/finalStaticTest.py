...
frontCam_warp = cv2.warpPerspective(frontActual, Hfront, (frontActual.shape[1], frontActual.shape[0]))
...
rightCam_warp = cv2.warpPerspective(rightActual, Hfront, (rightActual.shape[1], rightActual.shape[0]))
#cv2.putText(frontCam_warp, str(int(fps)), (10,70), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255),3)
#cv2.imshow('Front Cam Warped | q for exit', frontCam_warp)
cv2.resize(rightCam_warp, (0,0), fx=0.5, fy =0.5)

leftCam_warp = cv2.warpPerspective(leftActual, Hfront, (frontActual.shape[1], frontActual.shape[0]))
#cv2.putText(frontCam_warp, str(int(fps)), (10,70), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255),3)
#cv2.imshow('Front Cam Warped | q for exit', frontCam_warp)
cv2.resize(frontCam_warp, (0,0), fx=0.5, fy =0.5)
