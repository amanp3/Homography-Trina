...
# plt.imshow(frontActual)
# plt.show()
# plt.imshow(rightActual)
# plt.show()
# plt.imshow(leftActual)
# plt.show()
# plt.imshow(backActual)
# plt.show()
...
# plt.imshow(frontDesired)
# plt.show()
# plt.imshow(rightDesired)
# plt.show()
# plt.imshow(leftDesired)
# plt.show()
# plt.imshow(backDesired)
# plt.show()

#crop
frontActual = frontActual[100:529,0:900]
rightActual = rightActual[100:535,0:979]
leftActual = leftActual[100:537,50:950]
backActual = backActual[200:487,0:903]

frontDesired = frontDesired[100:529,200:800]
rightDesired = rightDesired[100:529,200:800]
leftDesired = leftDesired[100:529,200:800]
backDesired = backDesired[100:529,200:800]
t = time.time()
...
#crop
frontStitchImage = frontStitchImage[100:529,0:900]
rightStitchImage = rightStitchImage[100:535,0:979]
leftStitchImage = leftStitchImage[100:537,50:950]
backStitchImage = backStitchImage[200:487,0:903]
...
def calculateStitchingMatrix(img1, img1Gray, img2, img2Gray):
    ...
    #show the keypoints that are being matched for debugging
    plt.imshow(img3)
    plt.show() 
...
while True:
    ...
    #crop
    frameFront = frameFront[200:719,200:1100]
    frameRight = frameRight[200:719,200:1100]
    frameLeft = frameLeft[200:719,200:1100]
    frameBack = frameBack[200:719,200:1100]
